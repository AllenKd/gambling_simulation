...
class DbConstructor(object):
    ...
    def create_tables(self):
        ...
        def prediction_judgement_template(table_name): return Table(
            ...
            Column(db_constant.game_id, String(12), primary_key=True),
            Column(db_constant.win_national_point_spread_result, Integer),
            Column(db_constant.win_national_point_spread_percentage, Integer),
            Column(db_constant.win_national_point_spread_population, Integer),
            Column(db_constant.win_national_total_point_result, Integer),
            Column(db_constant.win_national_total_point_percentage, Integer),
            Column(db_constant.win_national_total_point_population, Integer),
            Column(db_constant.win_local_point_spread_result, Integer),
            Column(db_constant.win_local_point_spread_percentage, Integer),
            Column(db_constant.win_local_point_spread_population, Integer),
            Column(db_constant.win_local_total_point_result, Integer),
            Column(db_constant.win_local_total_point_percentage, Integer),
            Column(db_constant.win_local_total_point_population, Integer),
            Column(db_constant.win_local_original_result, Integer),
            Column(db_constant.win_local_original_percentage, Integer),
            Column(db_constant.win_local_original_population, Integer),
            schema=self.config[config_constant.DB][config_constant.schema])
        ...
        def template(table_name): return Table('{}_{}'.format(db_constant.prediction_data, table_name), MetaData(),
                                               ...
                                               Column(db_constant.percentage_national_total_point_guest, Integer),
                                               Column(db_constant.population_national_total_point_guest, Integer),
                                               ...
                                               Column(db_constant.percentage_local_total_point_guest, Integer),
                                               Column(db_constant.population_local_total_point_guest, Integer),
                                               ...
                                               Column(db_constant.percentage_national_total_point_host, Integer),
                                               Column(db_constant.population_national_total_point_host, Integer),
                                               ...
                                               Column(db_constant.percentage_local_total_point_host, Integer),
                                               Column(db_constant.population_local_total_point_host, Integer),
